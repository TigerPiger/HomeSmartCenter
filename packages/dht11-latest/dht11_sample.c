...
static void read_temp_entry(void *parameter)
{
    ...
    rt_device_control(dev, RT_SENSOR_CTRL_SET_FETCH_MODE, (void *)(&get_data_freq));
    ...
    while (1)
    {
        ...
        else
        {
            ...
            {
                uint8_t temp = ((rt_uint32_t)sensor_data.data.temp & 0xffff) >> 0;      // get temp
                uint8_t humi = ((rt_uint32_t)sensor_data.data.temp & 0xffff0000) >> 16; // get humi
